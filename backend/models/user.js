...
// Common media schema for games, music, and books
...
const UserSchema = new mongoose.Schema({
  ...
  readBooks: [MediaSchema],
  readingList: [MediaSchema],
  playedGames: [MediaSchema],
  gameList: [MediaSchema],
  listenedMusic: [MediaSchema],
  playlist: [MediaSchema],
  lists: [ListSchema],
  favoriteMovies: {
    allTime: [FavoriteSchema],
    year: [FavoriteSchema],
